  ...
  return (
    <footer className="bg-gray-800 text-white py-8 pl-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center md:flex-row md:items-start md:justify-center md:gap-32">
          <div className="w-full md:w-1/2 lg:w-1/4 mb-8">
            <h3 className="text-lg font-semibold mb-4">About Us</h3>
            <p className="text-sm">
              Our food ordering website provides a convenient way to order
